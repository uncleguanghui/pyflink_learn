...
> **业务场景**
> 
> 在实时流处理场景中，在线训练一个机器学习模型，并实现对模型训练过程的实时监控。

该案例展示了如何用 PyFlink + Scikit-Learn 进行在线机器学习，基于 Scikit-Learn 的 Digits 手写数据集，训练出一个分类模型，并利用自定义的 Metrics 实现模型指标的实时监控。

![数据流向图](images/image5.jpg)

> 待补充

![Web UI Metrics 视图](images/image5_1.jpg)
